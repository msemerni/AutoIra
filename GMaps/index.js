...
for (const key in hoursTextObj) {
  ...
  function E(){
    ...
    return!!(t.day||t.time.start||t.time.end)&&utilIsValidOperatingHourData(t,function(e){r.push(e+n),f.add(t.id)},function(e){o.push(e+n),g.add(t.id)})}),function(e){r.push(e)})),t={"opening_hours:pl":e};o.length||r.length?(s.container().call(n,o,r,e,L),S()):L(t)}